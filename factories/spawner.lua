...
local enemy_1_factory = require 'factories.bird_enemy'
local enemy_2_factory = require 'factories.ebabat_enemy'
local enemy_3_factory = require 'factories.bird_enemy'
local enemy_4_factory = require 'factories.ebabat_enemy'
